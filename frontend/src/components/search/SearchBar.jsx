...
export default function SearchBar({ onSearch, placeholder = 'Search movies...', buttonText = 'Search', type = 'text' }) {
    ...
    <form onSubmit={handleSubmit} className="w-full">
      <div className="relative flex gap-3 items-center">
        <div className="flex-1 relative group">
          ...
          />
          <Search className={`absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 transition-colors duration-300 group-focus-within:text-${type === 'ai' ? 'accent' : 'blue-500'}`} size={22} />
        </div>
